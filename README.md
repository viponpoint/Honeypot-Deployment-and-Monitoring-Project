...
The above diagram from Kibana dashboard, specifically focusing on the "Honeytrap" type helps in monitoring and analyzing the honeypot's attack data, allowing for better understanding and mitigation of security threats. The system received 7,636 attacks from 1,947 unique IPs in the past 24 hours. Attacks are globally distributed with significant concentrations in North America, Europe, and Asia. 
...
More from Honeytrap.. The histogram reveals which ports are being targeted, helping to understand which services are under attack while the tables provide details on the top ASNs and source IPs, giving a clearer picture of the primary sources of attacks
